...
class ContentProvideCommandsTest {
    ...
    @CsvSource({
            ...
            CRAPaths.MANAGER_HOME + ", " + CRA_JSPFiles.MANAGER_HOME,
            CRAPaths.ACTIVE_ORDERS + ", " + CRA_JSPFiles.MANAGER_HOME,
            CRAPaths.ORDER_HISTORY + ", " + CRA_JSPFiles.MANAGER_HOME,
            CRAPaths.CUSTOMERS + ", " + CRA_JSPFiles.MANAGER_HOME,
            CRAPaths.MASTERS + ", " + CRA_JSPFiles.MANAGER_HOME,
    ...
    void promptingRecourse_promptConcreteRecourse_dispatchToIt(String promptRecourse, String providedSource) throws ServletException, IOException {
