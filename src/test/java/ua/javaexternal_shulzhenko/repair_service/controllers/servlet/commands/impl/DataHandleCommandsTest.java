package ua.javaexternal_shulzhenko.repair_service.controllers.servlet.commands.impl;
...
import ua.javaexternal_shulzhenko.repair_service.constants.*;
import ua.javaexternal_shulzhenko.repair_service.controllers.servlet.commands.RequestHandler;
...
class DataHandleCommandsTest {
    ...
    @ParameterizedTest
    @CsvSource("Userfirstname, Userlastname, registration_testing@mail.com, User1234, User1234")
    void promptingRegistration_validData_createCustomerInDataBaseDispatchToRegistration(
    ...
    @ParameterizedTest
    @CsvSource({
            "Masterfirstname, Masterlastname, registration_testing_master@mail.com, Master123, Master123, MASTER",
            "Managerfirstname, Managerlastname, registration_testing_manager@mail.com, Manager123, Manager123, MANAGER"})
    void promptingManMasRegistration_validData_createUserInDataBaseDispatchToRegistration(
            String firstName, String lastName, String email,
    ...
    @ParameterizedTest
    @CsvSource("2, Some customer review")
    void promptingReviews_validData_createReviewInDatabaseDispatchToReviews(
            String customerID, String reviewContent) throws ServletException, IOException {
