...
import ua.javaexternal_shulzhenko.repair_service.constants.PaginationConstants;
...
import ua.javaexternal_shulzhenko.repair_service.services.pagination.Pagination;
import ua.javaexternal_shulzhenko.repair_service.services.pagination.impl.PagePaginationHandler;
...
public class ContentProvideCommands {
    ...
    static {
        ...
        COMMANDS.put(CRAPaths.HOME, (req, resp) -> {
            ...
            PageEntities<Review> reviews = ReviewsDBService.getReviewsByOffsetAmountAsPageEntities(offset,
