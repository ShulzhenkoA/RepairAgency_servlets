...
<c:if test="${requestScope['javax.servlet.forward.servlet_path'] eq '/master_home'}">
    <h4 class="up_h">Active orders that you have in progress:</h4>
</c:if>
<c:if test="${requestScope['javax.servlet.forward.servlet_path'] eq '/master_completed_orders'}">
